#!/bin/bash
# Start vLLM server for Qwen3-14B with Sleep Mode enabled
# Port: 8000
# Context: 64k tokens (realistic for 24GB VRAM)
...
LOG_FILE="$LOG_DIR/vllm_qwen3_14b_sleep.log"
...
echo "🚀 Starting Qwen3-14B with Sleep Mode on port $PORT..."
...
echo "✅ Qwen3-14B starting on port $PORT (Sleep Mode enabled)"
echo "📝 Logs: $LOG_FILE"
